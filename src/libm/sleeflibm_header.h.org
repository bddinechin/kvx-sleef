...
#if defined(__AVX2__) || defined(__aarch64__) || defined(__arm__) || defined(__powerpc64__) || defined(__zarch__) || defined(__KVX__)
#ifndef FP_FAST_FMA
#define FP_FAST_FMA
#endif
#ifndef FP_FAST_FMAF
...
typedef uint32_t SLEEF_VECTOR_UINT __attribute__((vector_size(sizeof(uint32_t)*VECTLEN*2)));
typedef double SLEEF_VECTOR_DOUBLE __attribute__((vector_size(sizeof(double)*VECTLEN)));
typedef int32_t SLEEF_VECTOR_INT __attribute__((vector_size(sizeof(int32_t)*VECTLEN)));
typedef float SLEEF_VECTOR_FLOAT __attribute__((vector_size(sizeof(float)*VECTLEN*2)));
typedef long long SLEEF_VECTOR_LONGLONG __attribute((vector_size(sizeof(long long)*VECTLEN*2)));
typedef unsigned long long SLEEF_VECTOR_ULONGLONG __attribute((vector_size(sizeof(unsigned long long)*VECTLEN*2)));
...
typedef float       float32x4_t     __attribute__((vector_size(sizeof(float)*4)));
typedef float       float32x8_t     __attribute__((vector_size(sizeof(float)*8)));
typedef double      float64x2_t     __attribute__((vector_size(sizeof(double)*2)));
typedef double      float64x4_t     __attribute__((vector_size(sizeof(double)*4)));
#endif
