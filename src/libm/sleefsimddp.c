...
#ifdef ENABLE_KVX_SIMD
#define CONFIG 1
#include "helperkvxsimd.h"
#ifdef DORENAME
#ifdef ENABLE_GNUABI
#include "renamekvx_simd_gnuabi.h"
#else
#include "renamekvx_simd.h"
#endif
#endif
#endif

#ifdef ENABLE_KVX_BIG_SIMD
#define CONFIG 2
#include "helperkvxsimd.h"
#ifdef DORENAME
#ifdef ENABLE_GNUABI
#include "renamekvx_big_simd_gnuabi.h"
#else
#include "renamekvx_big_simd.h"
#endif
#endif
#endif
...
#if defined(ENABLE_KVX_SIMD) || defined(ENABLE_KVX_SIMD)
  return vbcopysign_vd_vd_vd(x, y);
#else
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__)   
  vdouble2 u1, x1, y1;
  x1 = vcast_vd2_vd_vd(vsel_vd_vo_vd_vd(o, vneg_vd_vd(y), x), vcast_vd_d(0.0));
  y1 = vcast_vd2_vd_vd(vsel_vd_vo_vd_vd(o, x, y), vcast_vd_d(0.0));
  u1 = dddiv_vd2_vd2_vd2(x1, y1);
  u = vd2getx_vd_vd2(u1);
#else
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__)
  vdouble2 s1 = vcast_vd2_vd_vd(s, vcast_vd_d(0.0));
  vdouble2 t1 = vcast_vd2_vd_vd(t, vcast_vd_d(0.0));
  s1 = dddiv_vd2_vd2_vd2(s1, t1);
  t1 = ddmul_vd2_vd2_vd2(s1, s1);
  t1 = ddnormalize_vd2_vd2(t1);
  s = vd2getx_vd_vd2(s1);
  t = vd2getx_vd_vd2(t1);
#else
  s = vdiv_vd_vd_vd(s, t);
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__) 
  vdouble2 x1 = dddiv_vd2_vd2_vd2(ddadd2_vd2_vd_vd(vcast_vd_d(-1), m), ddadd2_vd2_vd_vd(vcast_vd_d(1), m));
  x = vd2getx_vd_vd2(x1);
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__)
  vdouble y = vmla_vd_vd_vd_vd(vcast_vd_d(0.5), e, vd2getx_vd_vd2(dddiv_vd2_vd2_vd2(vcast_vd2_vd_vd(vcast_vd_d(0.5), vcast_vd_d(0.0)), vcast_vd2_vd_vd(e, vcast_vd_d(0.0)))));
#else
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__)
  vdouble y = vd2getx_vd_vd2(dddiv_vd2_vd2_vd2(vcast_vd2_vd_vd(d, vcast_vd_d(0.0)), vcast_vd2_vd_vd(vadd_vd_vd_vd(vcast_vd_d(2), d), vcast_vd_d(0.0))));
#else
...
#if defined(__KVX_SIMD__) || defined(__KVX_BIG_SIMD__)
  vdouble t = vd2getx_vd_vd2(dddiv_vd2_vd2_vd2(vcast_vd2_vd_vd(min, vcast_vd_d(0.0)), vcast_vd2_vd_vd(max, vcast_vd_d(0.0))));
#else
