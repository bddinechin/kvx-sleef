...
#if defined(__AVX2__) || defined(__aarch64__) || defined(__arm__) || defined(__powerpc64__) || defined(__KVX__)
#ifndef FP_FAST_FMA
#define FP_FAST_FMA
#endif
#endif
...
#define CONFIG 2
#include "helperkvxsimd.h"
typedef Sleef_float64x4_t_2 vdouble2;
typedef Sleef_float32x8_t_2 vfloat2;
#endif
#endif
