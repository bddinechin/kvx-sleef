...
#define checkAccuracyY_d(mpfrFunc, childFunc, argx, bound) do {		\
  ...
  if (enableDP) {
    ...
    fprintf(stderr, "trunc : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_d(mpfr_trunc, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "floor : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_d(mpfr_floor, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "ceil : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_d(mpfr_ceil, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "round : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_d(mpfr_round, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "rint : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracy_d(mpfr_rint, y[i], x[i][0], 0);
...
#define checkAccuracy2_f_f(mpfrFunc, childFunc, argx, argy, bound, abound) do {	\
  ...
  if (enableSP) {
    ...
    fprintf(stderr, "truncf : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_f(mpfr_trunc, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "floorf : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_f(mpfr_floor, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "ceilf : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_f(mpfr_ceil, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "roundf : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracyNR_f(mpfr_round, y[i], x[i][0], 0);
    ...
    fprintf(stderr, "rintf : ");
    {
	    ...
	    for (int i = 0; i < 40; i++) checkAccuracy_f(mpfr_rint, y[i], x[i][0], 0);
